import { GenerationRequest, GenerationResponse, SavedPrompt, EtaStatus } from '../types'
...
class ApiService {
  ...
  async savePrompt(prompt: Omit<SavedPrompt, 'id' | 'created_at'>): Promise<{ success: boolean }> {
    try {
